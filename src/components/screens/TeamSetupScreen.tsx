...
export function TeamSetupScreen() {
  ...
  return (
    <div className="w-full h-full flex flex-col screen-base overflow-hidden">
      {/* Scrollable content area */}
      <div className="flex-1 overflow-y-auto p-6 flex flex-col items-center scrollbar-hide">
        {/* Progress dots */}
        <motion.div
        ...
        <div className="flex gap-5 w-full max-w-5xl items-start">
          ...
          <motion.div initial={{ x: 24, opacity: 0 }} animate={{ x: 0, opacity: 1 }} className="flex-1 min-w-0 flex flex-col gap-3">
            ...
            <GlassPanel className="p-4">
              ...
              <div className="grid gap-2 scrollbar-hide" style={{ gridTemplateColumns: 'repeat(5, 1fr)', maxHeight: '32vh', overflowY: 'auto' }}>
                {AVATARS.map((avatar) => {
