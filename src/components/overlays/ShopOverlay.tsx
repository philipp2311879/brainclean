  ...
  return (
    ...
    >
      <motion.div
        ...
        className="card w-full max-w-2xl flex flex-col overflow-hidden"
        style={{ borderColor: '#f97316', borderWidth: 2, maxHeight: '90vh' }}
      >
        {/* Fixed header */}
            ...
            {SHOP_ITEMS.map((type) => {
              ...
              return (
                <motion.div
                  ...
                  onClick={() => { if (canBuy) { buyItem(type as ItemType, teamId) } }}
                >
        ...
        {/* Fixed footer button */}
        <div className="flex-shrink-0 p-6 pt-4 border-t border-[#e5e7eb]">
